...
const { Crews, Tags, Statuses } = require('../dbObjects.js');
 ...
 * Commands we want:
 * - Set the crew name
 * - CRUD operations on crew themes
 * - NOTE: Also need to setup CRUD for tags to a theme
 * - View the crew's entire sheet
 *    - Display each theme under the crew
 */
module.exports = {
  data: new SlashCommandBuilder()
    .setName('crew')
    .setDescription('Manage the server\'s crew')
    .addSubcommand(sub =>
      sub
        .setName('add')
